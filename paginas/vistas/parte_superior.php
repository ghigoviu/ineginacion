      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="../infraestructuras/index.php">Colonias</a>
            <a class="collapse-item" href="../viviendas/index.php">Viviendas</a>
            <a class="collapse-item" href="../../bd/backup.php">Crear respaldo</a>
          </div>
        </div>
      </li>
      <!-- Divider -->
